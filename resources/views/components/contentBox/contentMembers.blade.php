<div id="flow_faq" class="contentFlowFaq">
    <div class="inner">

        <div class="header-entry">
            <h2 class="heading-block" data-aos="fade-up">
                <span class="ttl-ja c-l-v2">ご登録の流れ&よくある質問</span>
                <span class="ttl-en b-g">FLOW & FAQ</span>
            </h2>
        </div>

        <div class="flow_faqList">
            <div class="flow_faqItem" data-aos="fade-up">
                <p class="ttlBox b-g">flow</p>
                <div class="flow_faqInfo">
                    <p class="ttl">ご登録の流れ</p>
                    <picture class="image">
