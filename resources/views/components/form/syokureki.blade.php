...
{{--                </small>--}}
                <ul class="list-workExperience">
                    <li class="item-workExperience">
                    ...
                    <li class="item-workExperience">
                        ...
                        <div class="itemInfo">
                            <div class="multi-item">
                                <div class="fields">
                                    <x-molecules.select for="startYearA" :list="$fEntApplyMasters->yearMst??[]" :selected="old('startYearA', $fEntUserApplyInfo->kinmStrYymm1 ? (int)$fEntUserApplyInfo->kinmStrYymm1->format('Y')??'' : '')" defaultKey="" />
                                    <label for="startYearA">年</label>
                                    <x-molecules.validation-errors :errors="$errors" for="startYearA" />
                                </div>
                                <div class="fields">
                                    <x-molecules.select for="startMonthA" :list="$fEntApplyMasters->monthMst??[]" :selected="old('startMonthA', $fEntUserApplyInfo->kinmStrYymm1 ? (int)$fEntUserApplyInfo->kinmStrYymm1->format('m')??'' : '')" defaultKey="" />
                    ...
                    <li class="item-workExperience">
                        ...
                        <div class="itemInfo">
                            <div class="multi-item">
                                <div class="fields">
                                    <x-molecules.select for="endYearA" :list="$fEntApplyMasters->yearMst??[]" :selected="old('endYearA', $fEntUserApplyInfo->kinmEndYymm1 ? (int)$fEntUserApplyInfo->kinmEndYymm1->format('Y')??'' : '')" defaultKey="" />
                                    <label for="endYearA">年</label>
                                    <x-molecules.validation-errors :errors="$errors" for="endYearA" />
                                </div>
                                <div class="fields">
                                    <x-molecules.select for="endMonthA" :list="$fEntApplyMasters->monthMst??[]" :selected="old('endMonthA', $fEntUserApplyInfo->kinmEndYymm1 ? (int)$fEntUserApplyInfo->kinmEndYymm1->format('m')??'' : '')" defaultKey="" />
                    ...
                    <li class="item-workExperience">
                        ...
                        <div class="itemInfo">
                            <x-molecules.select for="employmentStatusA" :kbnList="$fEntApplyMasters->koyKeitaiMst" :selected="old('employmentStatusA', (int)$fEntUserApplyInfo->koyKeitaiKbn1 ?? '')" defaultKey="選択してください" />
